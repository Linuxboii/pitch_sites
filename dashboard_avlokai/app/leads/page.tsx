    ...
    return (
        <div className="space-y-8">
            ...
            >
                ...
                >
                    <Users className="h-8 w-8" style={{ color: "#3B82F6" }} strokeWidth={1.5} />
                </div>
                ...
                <p className="text-[13px] max-w-md mb-6 leading-relaxed" style={{ color: "#64748B" }}>
                    Lead data is sourced from your n8n workflows. Configure a CRM integration
                    (e.g., HubSpot, Salesforce, or a custom webhook) in n8n to capture and display leads here.
                </p>
                ...
                >
                    {[
                        { label: "Webhook", desc: "Capture form submissions" },
                        { label: "CRM Sync", desc: "Sync with HubSpot / Salesforce" },
                        { label: "Email", desc: "Parse inbound emails" },
                    ].map((item) => (
                        <div
                            key={item.label}
